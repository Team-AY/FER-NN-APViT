...
base_path = '/content/drive/MyDrive/Final_Project/Databases/fer-2013/'
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file=base_path + 'EmoLabel/Training/Training.txt',
            pipeline=train_pipeline),
    ),
    val=dict(
        type=dataset_type,
        data_prefix=image_path,
        ann_file=base_path + 'EmoLabel/Test/Test.txt',
